...
def download_youtube_audio(video_url, output_path=".", file_name=None):
    ...
    try:
        ...
        # Pytube will add its own extension, usually .mp4 for audio
...
if __name__ == "__main__":
    # Example usage:
    sample_video_url = "https://www.youtube.com/watch?v=dQw4w9WgXcQ" # Rick Astley. You can change this to test.
